package com.twopeople.game.blur;
        ...
        for (int y = 0; y < height; y++) {
            for (int x = 0; x < width; x++) {
                ...
                for (int row = -rows2; row <= rows2; row++) {
                    int iy = y + row;
                    int ioffset;
                    if (0 <= iy && iy < height) { ioffset = iy * width; } else if (edgeAction == CLAMP_EDGES) {
                        ioffset = y * width;
                    ...
                    for (int col = -cols2; col <= cols2; col++) {
                        ...
                        if (f != 0) {
                            int ix = x + col;
                            if (!(0 <= ix && ix < width)) {
                                if (edgeAction == CLAMP_EDGES) { ix = x; } else if (edgeAction == WRAP_EDGES) {
                                    ix = (x + width) % width;
                                } else { continue; }
                            }
            ...
            for (int x = 0; x < width; x++) {
                ...
                for (int col = -cols2; col <= cols2; col++) {
                    ...
                    if (f != 0) {
                        int ix = x + col;
                        if (ix < 0) {
                            if (edgeAction == CLAMP_EDGES) { ix = 0; } else if (edgeAction == WRAP_EDGES) {
                                ix = (x + width) % width;
                            }
                        } else if (ix >= width) {
                            if (edgeAction == CLAMP_EDGES) { ix = width - 1; } else if (edgeAction == WRAP_EDGES) {
                                ix = (x + width) % width;
                            }
                        }
                        int rgb = inPixels[ioffset + ix];
        ...
        for (int y = 0; y < height; y++) {
            for (int x = 0; x < width; x++) {
                ...
                for (int row = -rows2; row <= rows2; row++) {
                    ...
                    int ioffset;
                    if (iy < 0) {
                        if (edgeAction == CLAMP_EDGES) { ioffset = 0; } else if (edgeAction == WRAP_EDGES) {
                        ...
                        } else if (edgeAction == WRAP_EDGES) { ioffset = ((y + height) % height) * width; } else {
                            ioffset = iy * width;
                        }
